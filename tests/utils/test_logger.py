...
from apirun.utils.logger import (
    LogConfig,
    SisyphusLogger,
    get_logger,
...
class TestSisyphusLogger:
    ...
    def test_validation_failure_logging(self):
        ...
        logger.log_validation_failure(
            'eq', '$.json.code', 200, 404, 'Expected 200 but got 404'
        )
    ...
    def test_performance_metrics_logging(self):
        ...
        metrics = {'total_time': 2.5, 'dns_time': 0.1, 'tcp_time': 0.2, 'tls_time': 0.3}
        # Should not raise exception
    ...
    def test_console_handler_can_be_disabled(self):
        ...
        console_handlers = [
            h for h in stream_handlers if not isinstance(h, logging.FileHandler)
        ]
