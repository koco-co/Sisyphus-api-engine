...
1. **变量嵌套引用**:
   ```bash
   sisyphus-api-engine --cases examples/变量嵌套引用示例.yaml
   ```

2. **异步轮询**:
   ```bash
   sisyphus-api-engine --cases examples/异步轮询示例.yaml
   ```

3. **综合功能**:
   ```bash
   sisyphus-api-engine --cases examples/综合功能测试.yaml
   ```
...
```bash
# 验证 YAML 语法
sisyphus-api-validate examples/变量嵌套引用示例.yaml
sisyphus-api-validate examples/异步轮询示例.yaml
sisyphus-api-validate examples/综合功能测试.yaml
```
